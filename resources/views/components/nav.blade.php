<!-- Header -->
<header id="main-header" class="text-white shadow-lg fixed top-0 left-0 w-full z-50 transition-all duration-300">
    <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
            ...
            <nav id="navbarNav" class="hidden md:flex space-x-6">
                ...
                <a href="{{ route('front.index') }}#products" class="hover:text-blue-200 transition-colors">Produk</a>
                <a href="{{ route('front.index') }}#about" class="hover:text-blue-200 transition-colors">Tentang</a>
                <a href="{{ route('front.index') }}#contact" class="hover:text-blue-200 transition-colors">Kontak</a>
            </nav>
